...
async def notifySensorChange():
    received = json.dumps({ "msg_id": 5, "msg_type": "notify_sensor_change", "data": [{"id": 1, "vehicles_waiting": False, "vehicles_coming": False, "emergency_vehicle": False}, {"id": 2, "vehicles_waiting": True, "vehicles_coming": False, "emergency_vehicle": False}]})
